...
|-----------|---------|----------|
| Architecture, decisions, review | Tyrael | — |
| Next.js, overlays, game data | Deckard Cain | — |
| OBS web sources, CSS animations | Baal | — |
| APIs, WebSockets, data feeds | Mephisto | — |
| Quality, edge cases, stream testing | Diablo | — |
