      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-slate-950/95">
        <div className="space-y-8 p-8">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-6 text-2xl text-amber-200">
          ...
          <div className="grid grid-cols-7 gap-4">
            <div className="rounded-lg border border-amber-600/50 bg-slate-800/50 p-4 text-center">
      ...
      <div className="container flex flex-col gap-8 px-4 py-16">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="rounded-lg border border-amber-600/40 bg-slate-900 p-6 shadow-lg shadow-amber-900/20">
              <h2 className="mb-6 flex items-center gap-2 text-2xl font-bold text-amber-100">
                <span className="text-amber-500">◆</span>
                S.P.E.C.I.A.L. Stats
              </h2>
